...
{
	[TestFixture]
	public class ReporteTest : WebFormTestCase 
...
//		{
//			get { return new String[] { "assembly://Bic.Test/Bic.Test/app.config" }; }
//		}
		...
		public void GeneraConsultaWeb()
		{
			...
			TextBoxTester txtUsuario = new TextBoxTester("txtUsuario",CurrentWebForm);
			TextBoxTester txtContrasena = new TextBoxTester("txtContrasena");
			ButtonTester btnIniciar = new ButtonTester("btnIniciar"); 
	
			Browser.GetPage("http://localhost/bic/Login.aspx");
			Console.WriteLine(Browser.CurrentPageText);

			txtUsuario.Text = "arquitecto";
			txtContrasena.Text = "bic";
			btnIniciar.Click();

			
			Browser.GetPage("http://localhost/bic/ListaProyecto.aspx");
