<%@ Page language="c#" Codebehind="ListaAtributo.aspx.cs" AutoEventWireup="false" Inherits="bic.ListaAtributo" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<h2>Atributos</h2>
		...
		<asp:DataGrid id="dgAtributos" runat="server" DataKeyField="Id" AutoGenerateColumns="False" CellSpacing="0"
			...
			<Columns>
				...
				<asp:BoundColumn DataField="CampoId" HeaderText="ID"></asp:BoundColumn>
				<asp:BoundColumn DataField="CampoDescripcion" HeaderText="DESC"></asp:BoundColumn>
	...
	<p>Los atributos están definidos por una columna id y una descripción. blah blah bah...</p>
	<p>Si desea añadir un atributo haga click en el boton Agregar nuevo.</p>
	<p>Si que desea ir a la pantalla de edicion de un atributo haga click en el boton Editar.</p>
