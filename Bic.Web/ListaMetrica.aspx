<%@ Page language="c#" Codebehind="ListaMetrica.aspx.cs" AutoEventWireup="false" Inherits="Bic.Web.ListaMetrica" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<h2>Metricas</h2>
		...
		<asp:DataGrid id="dgMetricas" runat="server" DataKeyField="Id" AutoGenerateColumns="False" CellSpacing="0"
			...
			<Columns>
				...
				<asp:BoundColumn DataField="NombreHecho" HeaderText="Hecho"></asp:BoundColumn>
 				<asp:HyperLinkColumn Text="Editar" Target="_self" DataNavigateUrlField="Id" DataNavigateUrlFormatString="EdicionMetrica.aspx?id={0}"></asp:HyperLinkColumn>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				...
				<asp:CustomValidator Id="valHechos" runat="server"></asp:CustomValidator>
			</tr>
			<tr valign="bottom">
